...
export const OrganizerDashboard: React.FC = () => {
  ...
  return (
    <div className="flex-1 max-w-5xl mx-auto px-6 py-12 w-full">
      ...
      {/* Session Details Card (Testing & Verification) */}
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6">
          ...
          <div className="space-y-3 text-xs">
            ...
            <div className="flex justify-between py-2">
              ...
              <span className="text-emerald-400 font-semibold">Active (Persisted)</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 flex flex-col justify-between">
          <div>
            ...
            <p className="text-xs text-slate-300 leading-relaxed mb-4">
              This dashboard is a placeholder verifying that Supabase Auth, session persistence across page refreshes, and role-based route guards are fully operational for the <strong className="text-emerald-400">ORGANIZER</strong> role.
            </p>
            <div className="p-3.5 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-300 text-xs">
              ✓ Route protection active: Sponsor and Admin pages are locked against this account.
            </div>
          </div>

          <div className="mt-6 pt-4 border-t border-slate-800 text-[11px] text-slate-500">
            Next steps will integrate event listings and sponsorship proposals.
          </div>
        </div>
      </div>
    </div>
